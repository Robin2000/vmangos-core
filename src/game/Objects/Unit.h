...
enum VictimState
{
    VICTIMSTATE_UNAFFECTED     = 0,//ÎÞÉË                        // seen in relation with HITINFO_MISS
    VICTIMSTATE_NORMAL         = 1,//ÆÕÍ¨
    VICTIMSTATE_DODGE          = 2,//¶ãÉÁ
    VICTIMSTATE_PARRY          = 3,//¶Ü·À
    VICTIMSTATE_INTERRUPT      = 4,//´ò¶ÏÄ¿±ê
    VICTIMSTATE_BLOCKS         = 5,//×è¶Ï
    VICTIMSTATE_EVADES         = 6,//¹æ±Ü
    VICTIMSTATE_IS_IMMUNE      = 7,//ÃâÒß
    VICTIMSTATE_DEFLECTS       = 8//Æ«Ð±
};
